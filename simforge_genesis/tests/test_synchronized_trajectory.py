...
from simforge_genesis.control.synchronized_trajectory import SynchronizedTrajectoryManager
from simforge_genesis.core.trajectories import JointTrajectory
...
def test_start_and_sample(monkeypatch: pytest.MonkeyPatch, manager: SynchronizedTrajectoryManager) -> None:
    start_time = 100.0
    monkeypatch.setattr("simforge_genesis.control.synchronized_trajectory.time.time", lambda: start_time)
