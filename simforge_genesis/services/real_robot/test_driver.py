...
Usage:
    ...
    python -m simforge_genesis.services.real_robot.test_driver --robot-ip 192.168.1.9
...
def main():
    ...
    parser.add_argument(
        "--plan-file",
        default="/home/badal/simforge/simforge_genesis/logs/ur5e_ir_illuminator_test_plan.json",
